...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/audio/audio_platform_info_sku3_tasha.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_sku3_tasha.xml \
    $(LOCAL_PATH)/audio/audio_platform_info_sku4.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_sku4.xml \
    ...
    $(LOCAL_PATH)/audio/mixer_paths_mtp_aw.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_mtp_aw.xml \
    $(LOCAL_PATH)/audio/mixer_paths_mtp_awk9.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_mtp_awk9.xml \
    $(LOCAL_PATH)/audio/mixer_paths_mtp_fs1894.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_mtp_fs1894.xml \
    $(LOCAL_PATH)/audio/mixer_paths_mtp_spc.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_mtp_spc.xml \
    $(LOCAL_PATH)/audio/mixer_paths_mtp_ti.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_mtp_ti.xml \
    $(LOCAL_PATH)/audio/mixer_paths_sku3_tasha.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_sku3_tasha.xml \
    $(LOCAL_PATH)/audio/mixer_paths_sku4.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_sku4.xml \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/wifi/grippower.info:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/grippower.info \
